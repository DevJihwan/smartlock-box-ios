#!/usr/bin/env python3
"""
Script to add subscription files to the Xcode project
This manually modifies project.pbxproj file
"""
...
def add_files_to_pbxproj():
    ...
    shutil.copy(project_file, f"{project_file}.backup")
    print(f"✅ Backed up project file to {project_file}.backup")
    ...
    files = [
        {
            "name": "SubscriptionModels.swift",
            "path": "SmartLockBox/Models/SubscriptionModels.swift",
            "group": "Models"
        },
        {
            "name": "SubscriptionManager.swift",
            "path": "SmartLockBox/Managers/SubscriptionManager.swift",
            "group": "Managers"
        },
        {
            "name": "FreeTierSettingsView.swift",
            "path": "SmartLockBox/Views/Subscription/FreeTierSettingsView.swift",
            "group": "Subscription"
        },
        {
            "name": "UpgradePromptView.swift",
            "path": "SmartLockBox/Views/Subscription/UpgradePromptView.swift",
            "group": "Subscription"
        },
        {
            "name": "PremiumTierSettingsView.swift",
            "path": "SmartLockBox/Views/Subscription/PremiumTierSettingsView.swift",
            "group": "Subscription"
        },
        {
            "name": "TimeSlotEditorView.swift",
            "path": "SmartLockBox/Views/Subscription/TimeSlotEditorView.swift",
            "group": "Subscription"
        },
        {
            "name": "SubscriptionSettingsView.swift",
            "path": "SmartLockBox/Views/Subscription/SubscriptionSettingsView.swift",
            "group": "Subscription"
        },
    ]
    ...
    print("\n⚠️  Note: You may need to add the files to the correct groups manually in Xcode")
...
if __name__ == "__main__":
    try:
        ...
        print(f"\n❌ Error: {e}")
        print("The project file backup is available at SmartLockBox.xcodeproj/project.pbxproj.backup")
